...
<div class="container-fluid py-4">
    <div class="card">
        <div class="card-header pb-0">
            <h6>Tambah Kategori Wisata Baru</h6>
        </div>
        <div class="card-body">
...
@push('scripts')
<script>
    // Optional: Tambahkan preview untuk input file ikon
    document.getElementById('ikon').addEventListener('change', function(event) {
        const file = event.target.files[0];
        const reader = new FileReader();

        reader.onload = function(e) {
            // Jika Anda ingin menambahkan preview, 
            // Anda bisa membuat elemen img dan set src-nya
