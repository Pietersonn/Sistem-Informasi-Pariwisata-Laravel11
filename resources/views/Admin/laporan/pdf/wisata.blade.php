...
<body>
    ...
    <div class="stats">
        <div class="stat-item">
            <div class="stat-number">{{ $statistik['total_wisata'] }}</div>
            <div class="stat-label">Total Wisata</div>
        </div>
        <div class="stat-item">
            <div class="stat-number">{{ $statistik['wisata_aktif'] }}</div>
            <div class="stat-label">Wisata Aktif</div>
        </div>
        <div class="stat-item">
            <div class="stat-number">{{ $statistik['wisata_nonaktif'] }}</div>
            <div class="stat-label">Wisata Nonaktif</div>
        </div>
        <div class="stat-item">
            <div class="stat-number">{{ $statistik['wisata_menunggu'] }}</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <span class="badge badge-{{ $item->status == 'aktif' ? 'success' : ($item->status == 'nonaktif' ? 'secondary' : 'warning') }}">
