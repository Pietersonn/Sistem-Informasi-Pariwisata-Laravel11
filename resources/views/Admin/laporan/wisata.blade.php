                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="status" class="form-control">
                            ...
                            <option value="nonaktif" {{ $statusTerpilih == 'nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                            <option value="menunggu_persetujuan" {{ $statusTerpilih == 'menunggu_persetujuan' ? 'selected' : '' }}>Menunggu Persetujuan</option>
                        </select>
                    </div>
                                                ...
                                                <td>
                                                    <span class="badge 
                                                        {{ $item->status == 'aktif' ? 'bg-success' : 
                                                           ($item->status == 'nonaktif' ? 'bg-secondary' : 'bg-warning') }}">
