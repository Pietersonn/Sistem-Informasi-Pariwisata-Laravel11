        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('admin.laporan.event.pdf', request()->all()) }}" class="btn btn-success btn-sm"
                            target="_blank">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="status" class="form-control">
                                ...
                                <option value="selesai" {{ $statusTerpilih == 'selesai' ? 'selected' : '' }}>Selesai
                                </option>
                                <option value="dibatalkan" {{ $statusTerpilih == 'dibatalkan' ? 'selected' : '' }}>
                                    Dibatalkan</option>
                            </select>
                        </div>
                                            ...
                                            @foreach ($event as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge 
                                                        {{ $item->status == 'aktif' ? 'bg-success' : ($item->status == 'selesai' ? 'bg-secondary' : 'bg-warning') }}">
                                                            {{ $item->status_label }}
                                                        </span>
                                                    </td>
                                                    <td>
