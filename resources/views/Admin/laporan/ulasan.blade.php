                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="status" class="form-control">
                            ...
                            <option value="ditampilkan" {{ $statusTerpilih == 'ditampilkan' ? 'selected' : '' }}>Ditampilkan</option>
                            <option value="disembunyikan" {{ $statusTerpilih == 'disembunyikan' ? 'selected' : '' }}>Disembunyikan</option>
                            <option value="menunggu_moderasi" {{ $statusTerpilih == 'menunggu_moderasi' ? 'selected' : '' }}>Menunggu Moderasi</option>
                        </select>
                    </div>
