            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('admin.wisata.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('harga_tiket') is-invalid @enderror"
                                id="harga_tiket" name="harga_tiket" value="{{ old('harga_tiket') }}" min="0"
                                step="1000">
                        </div>
                    ...
                    <div class="card mt-4 mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="gambar">Pilih Gambar <small class="text-muted">(Multiple images
                                        allowed)</small></label>
                                <input type="file" class="form-control @error('gambar.*') is-invalid @enderror"
                                    name="gambar[]" accept="image/*" multiple id="gambar">
                                @error('gambar.*')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
