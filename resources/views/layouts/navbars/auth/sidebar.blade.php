        ...
        <ul class="navbar-nav">
                                    ...
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(153.000000, 2.000000)">
                                            <path class="color-background"
                                                ...
                                                opacity="0.6"></path>
                                            <path class="color-background"
                                                d="M15.5,20 C18.5375183,20 21,17.5375183 21,14.5 C21,11.4624817 18.5375183,9 15.5,9 C12.4624817,9 10,11.4624817 10,14.5 C10,17.5375183 12.4624817,20 15.5,20 Z"
                                                opacity="0.6"></path>
                                        </g>
                                    </g>
                                </g>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('admin/kategori*') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Katogori</span>
                </a>
            </li>
            <li class="nav-item">
