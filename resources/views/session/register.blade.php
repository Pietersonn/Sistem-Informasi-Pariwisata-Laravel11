<!-- resources/views/session/register.blade.php -->
                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form role="form text-left" method="POST" action="/register" enctype="multipart/form-data">
                                ...
                                <!-- Add file upload field for profile photo -->
                                <div class="mb-3">
                                    <label for="foto_profil" class="form-label text-sm text-secondary">Profile Photo
                                        (Optional)</label>
                ...
                imageInput.addEventListener('change', function() {
                    ...
                    if (this.files && this.files[0]) {
                        ...
                        reader.onload = function(e) {
                            ...
                            img.className = 'border shadow-sm';
