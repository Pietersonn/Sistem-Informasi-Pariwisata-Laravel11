                                ...
                                <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                @if (Auth::user()->foto_profil && Auth::user()->foto_profil != 'default.jpg')
                                                    <div class="mt-2">
                                                        <img src="{{ asset(Auth::user()->foto_profil) }}"
                                                            alt="Foto Profil" class="img-thumbnail" width="100">
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-actions">
                                        <button type="button" class="btn btn-secondary"
                                            id="cancel-edit-btn">Batal</button>
                            ...
                            <div class="favorit-list">
                                        ...
                                        <div class="favorit-card">
                                            ...
                                            <div class="favorit-card-content">
                                                ...
                                                <div class="favorit-card-location">
                                                    ...
                                                    {{ Str::limit($item->wisata->alamat, 50) }}
                                                </div>
                                                ...
                                                <div class="favorit-card-actions">
                                                    <a href="{{ route('wisata.detail', $item->wisata->slug) }}"
                                                        class="favorit-card-btn btn-view">Lihat Detail</a>
                                                    <form
                                                        action="{{ route('wisata.favorit.hapus', $item->wisata->slug) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                ...
                                @else
                                    <div class="text-center py-5 w-100">
                                        ...
                                        <a href="{{ route('wisata.index') }}" class="btn btn-primary mt-3">Jelajahi
                                            Wisata</a>
                                    </div>
                                @endif
                            </div>
                                    ...
                                    @foreach (Auth::user()->ulasan as $ulasan)
                                        <div class="ulasan-item">
                                            <div class="ulasan-header">
                                                <a href="{{ route('wisata.detail', $ulasan->wisata->slug) }}"
                                                    class="ulasan-wisata">{{ $ulasan->wisata->nama }}</a>
                                                <span
                                                    class="ulasan-date">{{ $ulasan->created_at->format('d M Y') }}</span>
                                            </div>
                                            ...
                                            <div class="ulasan-footer">
                                                <span
                                                    class="ulasan-status 
                                                @if ($ulasan->status == 'ditampilkan') status-displayed
